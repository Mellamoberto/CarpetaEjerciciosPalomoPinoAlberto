...
public class SimulacroExamenDiciembre extends JFrame {
    ...
    public SimulacroExamenDiciembre() {
        ...
        botonAceptar.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                JOptionPane.showMessageDialog(SimulacroExamenDiciembre.this, mensaje, "Información del Formulario", JOptionPane.INFORMATION_MESSAGE);
            }
        });
        ...
        botonCargarCurriculum.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                int seleccion = fileChooser.showOpenDialog(SimulacroExamenDiciembre.this);

                if (seleccion == JFileChooser.APPROVE_OPTION) {
                    File archivoSeleccionado = fileChooser.getSelectedFile();
                    JOptionPane.showMessageDialog(SimulacroExamenDiciembre.this,
    ...
    private void mostrarVentanaAgradecimiento() {
        JDialog dialogoAgradecimiento = new JDialog(SimulacroExamenDiciembre.this, "Agradecimiento", true);
        ...
        dialogoAgradecimiento.setLocationRelativeTo(SimulacroExamenDiciembre.this);
        dialogoAgradecimiento.setVisible(true);
    }

    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> {
            SimulacroExamenDiciembre ventana = new SimulacroExamenDiciembre();
